...
export default function Login() {
	...
	return (
		<div className="mx-auto flex min-h-screen max-w-sm flex-col justify-center px-4 py-10">
			<h1 className="text-center font-display text-2xl font-semibold text-ink">Seller sign in</h1>
			<p className="mt-1 text-center text-sm text-ink-muted">Manage your MarketHive storefront</p>
			...
			<form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4">
				...
				<div className="flex justify-end">
					<Link to="/seller/forgot-password" className="text-sm font-medium text-teal-600 hover:text-teal-700">
						Forgot password?
					</Link>
				</div>
			...
			<p className="mt-6 text-center text-sm text-ink-muted">
				New seller?{" "}
				<Link to="/seller/register" className="font-medium text-teal-600 hover:text-teal-700">
