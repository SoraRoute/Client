...
export default function Register() {
  ...
  if (step === "otp") {
    return (
      <div className="mx-auto max-w-sm py-10">
        <h1 className="text-center font-display text-2xl font-semibold text-ink">Verify your email</h1>
  ...
  return (
    <div className="mx-auto max-w-sm py-10">
      ...
      <p className="mt-1 text-center text-sm text-ink-muted">Join MarketHive in a minute</p>
