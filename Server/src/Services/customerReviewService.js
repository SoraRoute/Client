...
const reviewId= await customerReviewRepository.addReview(customerId, productId, rating, comment);
return{
    success:true,
...
async getReviews(productId){
    ...
    const reviews= await customerReviewRepository.getReviewsByProductId(productId);
    return {
        success:true,
        reviews
    }
...
async updateReview(customerId, reviewId, rating, comment){
    ...
    await customerReviewRepository.updateReview(reviewId,rating,
comment);
    return{
        success:true,
